  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          <div class="x_content">
          <form method="post" action="{{url('/')}}/edit/student/{{Session()->get('id')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @if($errors->any())
...
@if(count($result)>0)
              ...
              <div class="wrap">
                <div class="form-group">
                  ...
                  <input   type="text" class="form-control formpad" name="fname" value="{{$results->fname}}" placeholder="First Name">
                </div>
                <div class="form-group">
                  <label>Last Name</label>
                  <input   type="text" class="form-control formpad" name="lname" value="{{$results->lname}}" placeholder="Last Name">
                </div>
                <div class="form-group">
                  <label>Country</label>
