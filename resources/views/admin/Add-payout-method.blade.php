      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_content">
                <button type="button" class="btn btnpaymentmethod">Add Payout Method</button>
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <tr>
                      <td><img src="images/card.png" alt="image" style="width:8%;"></td>
                      <td>Americans Express Ending in 8765</td>
                      <td><a href="" style="color:blue;">Edit</a>&nbsp;&nbsp;<a href="" style="color:#e42829;">Remove</a></td>
                     
                      <td><a href="">Pay</a>  <a href="">Deactivate</a></td>
                    </tr>
                     <tr>
                      <td><img src="images/Paypal-icon.png" alt="image" style="width:8%;"></td>
                       <td>Paypal <a href="#" style="color:blue;">Kiranriaz5515@gmail.com</a></td>
                      <td><a href="" style="color:#e42829;">Remove</a></td>
