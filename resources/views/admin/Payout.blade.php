      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
           <div class="payoutpadding">
            <div class="x_panel" style="padding: 0px 10px !important;">
              <div class="x_content" style="padding:0px !important;margin:0px !important;">
              
                <div class="row">
                 <a href="" class="hoverbox">
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="paypalhead">
                 <h3>Paypal</h3>
                  </div>
                </div>
                 <div class="col-md-6 col-sm-6 col-xs-12">
                 <div class="paypalimg">
                 <img src="images/Paypal-icon.png" alt="image">
                  </div>
                </div>
                     ...
                     <div class="row">
                   <a href="add-credit-or-debit-card.html" class="hoverbox">
               ...
               <h3>Debit/Credit Card</h3>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="cardimg">
             <img src="images/card.png" alt="image" style="margin-left: 90px;"><img src="images/credit-card-icon.png" alt="image" style="width: 32%;
    float: right;">
                </div>
                 </div>
