                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <tr>
                      <td>HBL</td>
                      <td>AbdulRehaman</td>
                      <td>ayyanawan95@gmail.com</td>
                      <td>03014149409</td>
                       <td>$1500</td>
                        <td>$500</td>
                         <td>20-10-2018</td>
                      
                      <td><a href="" data-toggle="modal" data-target="#myModal">Pay</a>&nbsp;&nbsp;<a href="">Deactivate</a></td>
                    </tr>
                  </tbody>
                </table>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="color:#e31e24;">Pay</h4>
        </div>
        <div class="modal-body">
          <p>Total amount to be payed is $1900.<br>How much do you want to pay?</p>
        </div>
        <div class="modal-footer">
        <div class="row">
        <div class="col-md-10 col-sm-12">
         <input id="" type="text" class="form-control"  value="" placeholder="Enter amount"> 
           </div>  
           <div class="col-md-2 col-sm-6">                           
          <button type="button" class="btn btn-default btnmodalok" data-dismiss="modal">OK</button>
        </div>
        </div>
        </div>
      </div>
