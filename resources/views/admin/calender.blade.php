        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
          <div class="menu_section">
            <ul class="nav side-menu">
              ...
              <li><a><i class="fa fa-shopping-cart"></i>Earnings</a>
                <ul class="nav child_menu">
              ...
              <li><a><i class="fa fa-table"></i> Payout</a> </li>
            </ul>
          </div>
        </div>
        <!-- /sidebar menu --> 
      ...
      <div class="nav_menu">
        <nav>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class=""> <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img src="" alt="">Admin <span class=" fa fa-angle-down"></span> </a>
