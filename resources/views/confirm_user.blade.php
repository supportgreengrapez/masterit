		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr><td>
				<div style="line-height: 24px;">
					...
					New {{$customer_atype}} name  {{$customer_name}} and email {{$customer_username}} is signup to our portal.Please verify the account <a href="https://masterit.world/admin">Login</a>
					</span></font>
                </div>
                	<!-- padding --><div style="height: 40px; line-height: 40px; font-size: 10px;"> </div>
			</td></tr>
            <tr><td>
                ...
                <tr><td >
                    <div style="line-height: 24px;">
                            <font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167">
                                <span  style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">IBRAHIM ANWAR<br>
    MasterIT<br>
    0324-4244934<br>
    Katar Bund Road,<br>
    Thokar Niaz Baig<br>
