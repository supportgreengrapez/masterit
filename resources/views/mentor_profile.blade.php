  ...
  <div class="row">
    ...
    @if(count($result2)>0)
      ...
      @if(!empty($results->image))
             <img src="{{URL('/')}}/storage/images/{{$results->image}}" class="img-circle" alt="image"><br>
            @else
            <img src="{{url('/')}}/images/master_logo_gray.png" class="img-circle" alt="image"> <br>
          @endif
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="hirebutton">
        <a href="{{url('/')}}/login" type="button" class="button2">Hire
        </a>
      </div>
    </div>
  </div>
