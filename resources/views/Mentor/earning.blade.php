        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
          <div class="menu_section">
           <ul class="nav side-menu">
              <li><a href="students-detail.html"> <i class="fa fa-gift"></i>Students Detail</a>
                
              </li>
              <li><a href="skill-set.html"><i class="fa fa-edit"></i>Skill Set</a>
               
              </li>
              <li><a href="#"><i class="fa fa-shopping-cart"></i>Settings</a></li>
                 <li><a href="earning.html"><i class="fa fa-shopping-cart"></i>Earnings</a></li>
             
              <li><a href="payments.html"><i class="fa fa-table"></i> Payments </a></li>
            </ul>
          </div>
        </div>
        <!-- /sidebar menu --> 
